    ...
    return (
        <div className="flex flex-col gap-6 p-4 bg-background-dark pb-24">
            <div className="flex flex-col gap-2">
                <h1 className="text-3xl font-black italic tracking-tighter uppercase">Meu Perfil</h1>
                <p className="text-gray-400 text-sm">Gerencie suas informações na selva.</p>
            </div>
